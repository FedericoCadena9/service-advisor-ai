...
export function RecommendationConsole({ recommendation, onStartRun, onApproveRun, onAsk, onDraftQuote, onOpenReview, onDecideReview }: { recommendation?: RecommendationResponse; onStartRun: () => Promise<{ id: string; events: string[] }>; onApproveRun: () => Promise<void>; onAsk: (question: string) => Promise<string>; onDraftQuote: (serviceCodes: string[]) => Promise<QuoteDraftResponse>; onOpenReview: (serviceCodes: string[]) => Promise<QuoteReviewResponse>; onDecideReview: (reviewId: string, decision: 'approve' | 'reject', reason?: string) => Promise<QuoteDecisionResponse> }) {

...
import type { QuoteDraftResponse, RecommendationResponse } from '../../api/generated/types.gen'
import { useState } from 'react'
import { QuoteDraftPanel } from './QuoteDraftPanel'

export function RecommendationConsole({ recommendation, onStartRun, onApproveRun, onAsk, onDraftQuote }: { recommendation?: RecommendationResponse; onStartRun: () => Promise<{ id: string; events: string[] }>; onApproveRun: () => Promise<void>; onAsk: (question: string) => Promise<string>; onDraftQuote: (serviceCodes: string[]) => Promise<QuoteDraftResponse> }) {
